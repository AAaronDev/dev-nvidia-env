...
typedef enum {
   ...
   * record structure is \ref CUpti_ActivityMemset2.
   */
   ...
   * The corresponding activity record structure is \ref CUpti_ActivityKernel5.
   */
   ...
   * structure is \ref CUpti_ActivityMemcpyPtoP2.
   */
 ...
 * CUpti_ActivityKernel5 activity record.
 */
typedef struct PACKED_ALIGNMENT {
  /**
 ...
 * (CUPTI_ACTIVITY_KIND_KERNEL and
 * CUPTI_ACTIVITY_KIND_CONCURRENT_KERNEL).
 * Kernel activities are now reported using the CUpti_ActivityKernel5 activity
 * record.
 */
typedef struct PACKED_ALIGNMENT {
  /**
